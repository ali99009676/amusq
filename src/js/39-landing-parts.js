...
const LP_TIPS = [
  ['🔁', 'الاسترجاع النشط لا القراءة',
   'أن تسأل نفسك وتحاول التذكر أقوى أثرًا من إعادة قراءة الملف مرات. لهذا بنك AMUSQ يبدأ بالسؤال لا بالجواب.'],
  ['📆', 'وزّع المراجعة على أيام',
   'ساعة يوميًا لخمسة أيام تثبّت أكثر من خمس ساعات في ليلة. العدّاد التنازلي هنا يساعدك على التوزيع.'],
  ['🎯', 'طارد أخطاءك',
   'السؤال الذي أخطأت فيه هو أنفع سؤال لك. AMUSQ يقدّمه في الاختبار القادم ويتيح إعادة الأخطاء وحدها.'],
...
AMUSQ.views.lpParts = { lpExams, lpTryQuestion, lpMemoCard, LP_TIPS, LP_FAQ, LP_DEMO };
