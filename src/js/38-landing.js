...
function landingView(){
  ...
  root.appendChild(el('header', { class:'lp-hero' }, [
    ...
    el('p', { class:'lp-hero__sub', text:
      ...
      'أيًّا كان تخصصك — طب أو هندسة أو حاسب أو قانون أو إدارة — بنك أسئلة منقّح من ملفات دكاترتك حرفًا بحرف، مع شرح لكل إجابة، وبطاقات حفظ ذكية، واختبارات تجريبية تحاكي الامتحان الحقيقي. ويعمل بلا إنترنت.' }),
  ...
  /* ٥-ج · مواد الطلاب — الميزة التي تجعل المنصة تنمو بلا مشرف */
  root.appendChild(lpSection('لطلاب المواد الناقصة', 'مادتك ليست هنا؟ ارفعها أنت',
    ...
    el('div', { class:'lp-steps' }, [
      lpStep(1, 'ارفع ملفك', 'PDF أو Word أو نص. واختر: نحافظ على النص حرفًا بحرف، أو نحسّن صياغته بالذكاء — والأصل يبقى محفوظًا في الحالتين.'),
