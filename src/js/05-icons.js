...
/*
  ═══ علامات مزوّدي الدخول ═══
  ★ مرسومةٌ بالمسارات لا بصورٍ من الشبكة: المنصة تعمل من الملف بلا إنترنت،
  وشعارٌ لا يُحمَّل يترك زرًّا أعمى.

  ★ وبألوانها الحقيقية.
  هذه الألوان ليست من نظام تصميمنا حتى تُشتقّ من متغيّراته — هي علاماتٌ
  تجارية يعرفها الطالب بلونها قبل شكلها، وأزرقُ فيسبوك المُقارَب خطأٌ لا
  اجتهاد. فتُكتب صريحةً هنا وحدها (لا في CSS)، ولا تدخل لوحة المنصة أبدًا.

  الشكل: إمّا مسارٌ واحد يأخذ اللون المطلوب، أو عدّة مسارات لكلٍّ لونه
  (جوجل ومايكروسوفت) — والشعار متعدّد الألوان لا يُختصر إلى لونٍ واحد.
*/
const BRAND_MARKS = {
  google: [
    { d:'M21.6 12.2c0-.7-.1-1.4-.2-2H12v3.9h5.4a4.6 4.6 0 0 1-2 3v2.5h3.2c1.9-1.7 3-4.3 3-7.4z', c:'#4285F4' },
    { d:'M12 22c2.7 0 5-.9 6.6-2.4l-3.2-2.5c-.9.6-2 1-3.4 1-2.6 0-4.8-1.8-5.6-4.1H3.1v2.6A10 10 0 0 0 12 22z', c:'#34A853' },
    { d:'M6.4 14c-.2-.6-.3-1.3-.3-2s.1-1.4.3-2V7.4H3.1a10 10 0 0 0 0 9.2z', c:'#FBBC05' },
    { d:'M12 5.9c1.5 0 2.8.5 3.8 1.5l2.8-2.8C16.9 2.9 14.7 2 12 2a10 10 0 0 0-8.9 5.4L6.4 10c.8-2.3 3-4.1 5.6-4.1z', c:'#EA4335' }
  ],
  microsoft: [
    { d:'M3 3h8.4v8.4H3z',       c:'#F25022' },
    { d:'M12.6 3H21v8.4h-8.4z',  c:'#7FBA00' },
    { d:'M3 12.6h8.4V21H3z',     c:'#00A4EF' },
    { d:'M12.6 12.6H21V21h-8.4z',c:'#FFB900' }
  ],
  apple:     [{ d:'M17.05 12.5c0-2.3 1.9-3.4 2-3.5-1.1-1.6-2.8-1.8-3.4-1.8-1.4-.1-2.8.8-3.5.8-.7 0-1.9-.8-3.1-.8-1.6 0-3 .9-3.8 2.3-1.6 2.8-.4 7 1.2 9.3.8 1.1 1.7 2.4 2.9 2.3 1.2 0 1.6-.7 3-.7s1.8.7 3 .7c1.3 0 2.1-1.1 2.8-2.2.9-1.3 1.3-2.5 1.3-2.6-.1 0-2.4-.9-2.4-3.8zM14.7 5.3c.6-.8 1-1.9.9-3-.9 0-2 .6-2.7 1.4-.6.7-1.1 1.8-.9 2.9 1 .1 2-.5 2.7-1.3z' }],
  facebook:  [{ d:'M13 22v-8h2.7l.4-3H13V9.1c0-.9.2-1.5 1.5-1.5H16V5c-.3 0-1.2-.1-2.3-.1-2.3 0-3.7 1.4-3.7 3.9V11H7.5v3H10v8z' }],
  x:         [{ d:'M18.2 2h3.3l-7.2 8.3L22.8 22h-6.6l-5.2-6.8L5.1 22H1.8l7.7-8.8L1.2 2h6.8l4.7 6.2zM17 20h1.8L7.1 3.9H5.1z' }],
  ...
  snapchat:  [{ d:'M12 2c2.8 0 5 2.2 5 5v2.2c.6-.3 1.2-.4 1.6-.1.5.3.5.9.1 1.3-.4.4-1.2.7-1.7 1-.3.2-.4.4-.3.7.5 1.3 1.6 2.6 3 3 .4.1.6.5.5.9-.2.6-1.2.9-2.2 1-.2 0-.3.2-.4.5-.1.4-.2.8-.7.8-.6 0-1.2-.2-1.9-.1-.8.1-1.4.6-2 1-.6.4-1.3.8-2 .8s-1.4-.4-2-.8c-.6-.4-1.2-.9-2-1-.7-.1-1.3.1-1.9.1-.5 0-.6-.4-.7-.8-.1-.3-.2-.5-.4-.5-1-.1-2-.4-2.2-1-.1-.4.1-.8.5-.9 1.4-.4 2.5-1.7 3-3 .1-.3 0-.5-.3-.7-.5-.3-1.3-.6-1.7-1-.4-.4-.4-1 .1-1.3.4-.3 1-.2 1.6.1V7c0-2.8 2.2-5 5-5z' }],
  linkedin:  [{ d:'M5 3.5a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5zM3 9.5h4V21H3zM10 9.5h3.8v1.6c.5-1 1.8-2 3.7-2 4 0 4.5 2.5 4.5 5.8V21h-4v-5.5c0-1.3 0-3-1.9-3s-2.1 1.4-2.1 2.9V21h-4z' }]
};
/* الأسماء القديمة تبقى مسارًا واحدًا لمن كان يقرؤها */
const BRAND_PATHS = Object.keys(BRAND_MARKS).reduce((o, k) => {
  o[k] = BRAND_MARKS[k].map(p => p.d).join(''); return o;
}, {});

/*
  شعارٌ ممتلئ لا خطّي: الشعارات تُعرف بكتلتها، ورسمُها بخطٍّ رفيع يُشوّهها.
  fill: لونُ الشعار الأحادي (أبيض على قرصٍ ملوّن مثلًا)؛ ومتعدّدُ الألوان
  يحتفظ بألوانه إلا أن يُطلب mono صراحةً — كما في شارةٍ صغيرة داخل نص.
*/
function brand(name, opts){
  ...
  svg.setAttribute('class', 'ico ico--brand' + (o.cls ? ' ' + o.cls : ''));
  const marks = BRAND_MARKS[name] || [{ d: ICON_PATHS.user }];
  marks.forEach(m => {
    const path = document.createElementNS(NS, 'path');
    path.setAttribute('d', m.d);
    path.setAttribute('fill', o.mono ? 'currentColor' : (m.c || o.fill || 'currentColor'));
    svg.appendChild(path);
  });
  return svg;
}
...
QBANK.BRAND_PATHS = BRAND_PATHS;
QBANK.BRAND_MARKS = BRAND_MARKS;
